...
const ShopBag = ({ isAdded }: { isAdded: boolean }) => {
    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg"
                fill={isAdded ? "blue" : "#000000"}
                height="50px"
                width="50px"
                version="1.1"
                id="Capa_1"
